    ...
    <aside className="w-64 bg-side-bg text-white h-screen fixed left-0 top-0 flex flex-col p-6 z-50">
      ...
      <div className="mt-auto space-y-4">
        ...
        <div className="pt-6 border-t border-white/5">
          <p className="text-[10px] text-white/30 font-medium text-center uppercase tracking-widest leading-relaxed">
            © {new Date().getFullYear()} CivicGuard Kigali<br/>
            <span className="text-white/20">Republic of Rwanda</span>
          </p>
        </div>
      </div>
    </aside>
